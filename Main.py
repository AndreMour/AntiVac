...
imagem_fundo = tk.PhotoImage(file="fundo.gif")
...
selecionar_botao = tk.Button(
    frame1, text="Selecionar pasta/arquivo", command=verificar_arquivos)
selecionar_botao.pack(side=tk.LEFT, padx=5)

excluir_botao = tk.Button(
    frame1, text="Excluir arquivo", command=excluir_arquivo)
excluir_botao.pack(side=tk.LEFT)

resultado_label = tk.Label(janela, text="")
resultado_label.pack()

lista_arquivos = tk.Listbox(janela, selectmode=tk.SINGLE, width=99, height=15)
